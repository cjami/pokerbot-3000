...
ELEVENLABS_OUTPUT_FORMAT_ENV: Final = "ELEVENLABS_OUTPUT_FORMAT"
...
DEFAULT_OUTPUT_FORMAT: Final = "mp3_22050_32"
...
class ElevenLabsConfig:
    ...
    def from_env(cls, env_file: str | Path | None = None) -> ElevenLabsConfig:
        ...
        return cls(
            ...
            output_format=os.getenv(ELEVENLABS_OUTPUT_FORMAT_ENV, DEFAULT_OUTPUT_FORMAT),
